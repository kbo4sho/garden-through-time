...
const plants = ["fothergilla", "hydrangea", "dogwood"];
...
if (pngNames.length !== expectedNames.length) {
  errors.push(`Expected exactly 15 PNGs; found ${pngNames.length}.`);
}
...
if (errors.length) {
  ...
  console.log(
    `Editorial asset audit passed: ${expectedNames.length} unique 600x600 alpha PNGs.`,
  );
}
